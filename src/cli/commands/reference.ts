...
export const COMMANDS: readonly CommandEntry[] = [
  ...
  },
  {
    ...
    usage: "storybloq ticket create --title <t> --type <type> [--phase <p>] [--description <d>] [--blocked-by <ids>] [--parent-ticket <id>] [--risk <low|medium|high>] [--format json|md]",
    flags: ["--title", "--type", "--phase", "--description", "--blocked-by", "--parent-ticket", "--risk"],
  },
  {
    name: "ticket update",
    description: "Update a ticket",
    usage: "storybloq ticket update <id> [--status <s>] [--title <t>] [--type <type>] [--phase <p>] [--order <n>] [--description <d>] [--blocked-by <ids>] [--parent-ticket <id>] [--risk <low|medium|high>] [--format json|md]",
    flags: ["--status", "--title", "--type", "--phase", "--order", "--description", "--blocked-by", "--parent-ticket", "--risk"],
  },
  {
    name: "ticket meta",
...
export const MCP_TOOLS: readonly McpToolEntry[] = [
  ...
  { name: "storybloq_ticket_create", description: "Create ticket. risk seed drives review depth/skip gates; unset = never skip", params: ["title", "type", "phase?", "description?", "blockedBy?", "parentTicket?", "risk?"] },
  { name: "storybloq_ticket_update", description: "Update ticket. risk seed drives review depth/skip gates; unset = never skip", params: ["id", "status?", "title?", "type?", "order?", "description?", "phase?", "parentTicket?", "blockedBy?", "risk?"] },
